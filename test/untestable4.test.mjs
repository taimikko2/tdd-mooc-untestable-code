...
describe("Untestable 4: enterprise application", () => {
  ...
  it("password can be changed", async () => {
    ...
    console.log("talletetaan user2 :    " + JSON.stringify(user2) + " old pw: " + pwd);
    await service.save(user2);
    const newPwd = "toinen " + pwd;
    let newHash = await service.hashPassword(newPwd);
    console.log("kohta change Password: " + JSON.stringify(user2) + " new pw: " + newPwd);
